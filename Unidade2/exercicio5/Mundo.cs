...
namespace gcgcg
{
  public class Mundo : GameWindow
  {
    ...
    protected override void OnLoad()
    {
      ...
      double raio = 0.5;
      semiLado = (raio * Math.Sqrt(2)) / 2.0;
      #region Objeto: retângulo  externo
      objetoSelecionado = new Retangulo(mundo, ref rotuloAtual,   new Ponto4D(cx - raio, cy - raio),
  new Ponto4D(cx + raio, cy + raio))
      {
      ...
      objetoSelecionado = new Circulo(mundo, ref rotuloAtual, raio, new Ponto4D(cx, cy))
      {
        PrimitivaTipo = PrimitiveType.LineLoop
      };
      retanguloLimite = new Retangulo(mundo, ref rotuloAtual, new Ponto4D(cx - semiLado, cy - semiLado),
      new Ponto4D(cx + semiLado, cy + semiLado))
      {
        PrimitivaTipo = PrimitiveType.LineLoop
      };
      ...
      #endregion
      #region Objeto: ponto  
      objetoSelecionado = new Ponto(mundo, ref rotuloAtual, new Ponto4D(cx, cy))
      {
        PrimitivaTipo = PrimitiveType.Points,
        PrimitivaTamanho = 10
      };
      #endregion
      #region Objeto: circulo 2
      double raioTemp = raio - 0.4;
      pontoCentroCirculoMenor = new Ponto(mundo, ref rotuloAtual, new Ponto4D(cx, cy))
      {
        PrimitivaTipo = PrimitiveType.Points,
        PrimitivaTamanho = 10
      };
      circuloMove = new Circulo(mundo, ref rotuloAtual, raioTemp, new Ponto4D(cx, cy))
      {
        PrimitivaTipo = PrimitiveType.LineLoop
      };
      objetoSelecionado = circuloMove;
      #endregion
    ...
    protected override void OnUpdateFrame(FrameEventArgs e)
    {
      ...
      {
        circuloMove.MoverCentro(0, passo);
        AtualizarCentroPonto();
        VerificarColisao();
      }

      if (estadoTeclado.IsKeyDown(Keys.B))
      {
        circuloMove.MoverCentro(0, -passo);
        AtualizarCentroPonto();
        VerificarColisao();
      ...
      {
        circuloMove.MoverCentro(-passo, 0);
        AtualizarCentroPonto();
        VerificarColisao();
      }
